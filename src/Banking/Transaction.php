...
class Transaction extends Element
{
    public function __construct(
        ...
        private DateTimeInterface $settlementDate,
        ...
        private ?string $presenterReference,
        private ?string $description,
        private ?DateTimeInterface $initialTransactionSettlementDate,
        private ?string $initialOperationPresenterReference,
